---
description: Spec Creation Rules for Builder AI
globs:
alwaysApply: false
version: 1.1
encoding: UTF-8
...
<actions> 1. CHECK @.builder-ai/product/roadmap.md 2. FIND next uncompleted item 3. SUGGEST item to user 4. WAIT for approval
</actions>
</option_a_flow>
...
Use the context-fetcher subagent to read @.builder-ai/product/mission-lite.md and @.builder-ai/product/tech-stack.md only if not already in context to ensure minimal context for spec alignment.
...
Use the file-creator subagent to create directory: .builder-ai/specs/YYYY-MM-DD-spec-name/ using the date from step 4.
...
Use the file-creator subagent to create the file: .builder-ai/specs/YYYY-MM-DD-spec-name/spec.md using this template:
...
Use the file-creator subagent to create the file: .builder-ai/specs/YYYY-MM-DD-spec-name/spec-lite.md for the purpose of establishing a condensed spec for efficient AI context usage.
...
<file_template>
  ...
  <header>
    ...
    This is the technical specification for the spec detailed in @.builder-ai/specs/YYYY-MM-DD-spec-name/spec.md
...
<file_template>
  ...
  <header>
    ...
    This is the database schema implementation for the spec detailed in @.builder-ai/specs/YYYY-MM-DD-spec-name/spec.md
...
<file_template>
  ...
  <header>
    ...
    This is the API specification for the spec detailed in @.builder-ai/specs/YYYY-MM-DD-spec-name/spec.md
...
- Spec Requirements: @.builder-ai/specs/YYYY-MM-DD-spec-name/spec.md
- Spec Summary: @.builder-ai/specs/YYYY-MM-DD-spec-name/spec-lite.md
- Technical Spec: @.builder-ai/specs/YYYY-MM-DD-spec-name/sub-specs/technical-spec.md
