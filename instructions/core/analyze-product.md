---
description: Analyze Current Product & Install Builder AI
globs:
alwaysApply: false
version: 1.0
encoding: UTF-8
...
# Analyze Current Product & Install Builder AI

## Overview

Install Builder AI into an existing codebase, analyze current product state and progress. Builds on plan-product.md
...
To properly set up Builder AI, I need to understand:
...
Execute our standard flow for installing Builder AI in existing products
...
I'm installing Builder AI into an existing product. Here's what I've gathered:
...
<instructions>
  ...
  ALLOW: plan-product.md to create .builder-ai/product/ structure
</instructions>
...
Verify installation completeness and provide clear next steps for the user to start using Builder AI with their existing codebase.

<verification_checklist>

- [ ] .builder-ai/product/ directory created
...
## ✅ Builder AI Successfully Installed

I've analyzed your [PRODUCT_TYPE] codebase and set up Builder AI with documentation that reflects your actual implementation.
...
- ✓ Product documentation in `.builder-ai/product/`
- ✓ Roadmap with completed work in Phase 0
- ✓ Tech stack reflecting actual dependencies

### Next Steps

1. Review the generated documentation in `.builder-ai/product/`
2. Make any necessary adjustments to reflect your vision
3. See the Builder AI README for usage instructions: https://github.com/CodefiLabs/builder-ai
4. Start using Builder AI for your next feature:
   ```
   @.builder-ai/instructions/core/create-spec.md
   ```

Your codebase is now Builder AI-enabled! 🚀
</summary_template>
